...
namespace RiskEventNotifacion.Presentation.Facades
{
    public class AlertsFacade : IAlertsFacade
    {
        ...
        {
            return await this.alertsService.GenerarateAlertAsync(alert.EventType, alert.RiskLevel, alert.Title, alert.Message, alert.Location, alert.Source, alert.Instructions,alert.Channels)
        }
    }
}
